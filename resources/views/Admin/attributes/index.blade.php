...
@section('content')
    ...
    <div class="card">
        <div class="card-header border-transparent">
            ...
            <a class="btn btn-app pull-left" href="{{route('attributes-group.create')}}">
        ...
        <div class="card-body p-0" style="display: block;">
            <div class="table-responsive">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <div class="d-inline-block">
                                    <form method="post" action="{{route('attributes-group.destroy',$attribute->id)}}">
                                        @csrf
                ...
                <div class="col-md-12">{{$attributes->links()}}</div>
            </div>
            <!-- /.table-responsive -->
        </div>
        <!-- /.card-body -->
